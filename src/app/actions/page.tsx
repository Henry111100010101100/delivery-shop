...
const AllActions = async () => {
  ...
  try {
    ...
    error = 'Ошибка при получении всех акционных продуктов';
    console.error('Ошибка в компоненте AllActions', e);
  }

  if (error) {
    return <div className='text-red-500'>{`${error} в компоненте AllActions`}</div>
  }
